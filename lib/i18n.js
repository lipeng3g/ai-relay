...
(function (global) {
  ...
  const dict = {
    ...
    'setting_clear_desc': { zh: '删除 AICarry 本地保存的会话。重新访问原始 AI 页面时，这些会话可能再次被捕获。', en: 'Delete conversations stored by AICarry. They may be captured again when you revisit the original AI pages.' },
    'btn_clear': { zh: '清除数据', en: 'Clear Data' },
    'setting_about': { zh: '关于', en: 'About' },
    'about_desc': { zh: 'AICarry v{version} · 跨 AI 对话助手', en: 'AICarry v{version} · Cross-AI Conversation Assistant' },
    ...
    'confirm_clear': { zh: '确定删除 AICarry 本地保存的所有会话吗？\n\n重新访问原始 AI 页面时，这些会话可能再次被捕获。', en: 'Delete all conversations stored by AICarry?\n\nThey may be captured again when you revisit the original AI pages.' },
    ...
    'empty_new_chat_body': { zh: '发送第一条消息后，AICarry 会自动显示原始会话。', en: 'Send the first message and AICarry will display the original conversation automatically.' },
    ...
    'snap_header': { zh: '# AICarry 接力文本 · 来自 {source} · {date}\n> 模式：{mode} · 原始对话 {msgs} 条（{turns} 轮）', en: '# AICarry Relay Text · from {source} · {date}\n> Mode: {mode} · Original: {msgs} messages ({turns} turns)' },
